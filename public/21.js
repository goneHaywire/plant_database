...
/***/ "./resources/js/src/services/SpeciesService.js":
/*!*****************************************************!*\
  !*** ./resources/js/src/services/SpeciesService.js ***!
  \*****************************************************/
/*! exports provided: default */
...
var speciesService = {
  fetchSpecies: function fetchSpecies() {
    ...
    return _Api__WEBPACK_IMPORTED_MODULE_0__["default"].get("/species?page=".concat(page));
  },
  fetchSpecie: function fetchSpecie(id) {
    return _Api__WEBPACK_IMPORTED_MODULE_0__["default"].get("/species/".concat(id));
  },
  createSpecie: function createSpecie(specie) {
